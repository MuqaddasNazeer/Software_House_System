...
const ViewEmployeeDetails = ({ employeeDetails, onClose }) => {
    ...
    useEffect(() => {
        ...
        setProjects(employeeDetails.projectsData)
    });
            ...
            <div className="bg-white rounded-md p-6">
                ...
                <div className="flex mb-4 justify-between">
                    <div className="mr-4">
                        <p className="text-gray-600">
                            <span className="font-semibold">Employee Name:</span> {employeeDetails.employeeData?.username}
                        </p>
                    </div>
                    <div>
                        <p className="text-gray-600">
                            <span className="font-semibold">Email:</span> {employeeDetails.employeeData?.email}
                        </p>
                    </div>
                </div>
                ...
                {projects.length == 0 ? (
                    ...
                    <div className="text-center">
                        No projects assigned to employee
                    </div>
                ) : (
                    <>
                        <div className='mb-3'>
